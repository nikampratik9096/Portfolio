        ...
        <section id="about">
            <div className="container about-main">
                ...
                <div className="about-content">
                    ...
                    <p>I am 3* star coder on GeeksforGeeks and 1700 + rated on Leetcode . Its fun for me taking part in Competitive Programming. I am curious to know about how things work around.</p>
